    ...
    <div style="margin-top: 50px; width:800px;">
        <form class="layui-form" action="" id="data-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="Tanswer" required  lay-verify="required" placeholder="请输入正确答案" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div id="all-option">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="option1" required  lay-verify="required" placeholder="请输入答案选项" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">选项</label>
                    <div class="layui-input-block">
                        <input type="text" name="option2" required  lay-verify="required" placeholder="请输入答案选项" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item" id="clone-Node">
                    <label class="layui-form-label">选项</label>
                    <div class="layui-input-block">
                        <input type="text" name="option3" required  lay-verify="required" placeholder="请输入答案选项" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">选项</label>
                    <div class="layui-input-block">
                        <input type="text" name="option4" required  lay-verify="required" placeholder="请输入答案选项" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item icon_style">
                <div class="layui-input-block">
                    <span><a href="#" onclick="add_input()"><i class="layui-icon layui-icon-add-circle" style="font-size: 30px; color: #1E9FFF;"></i></a></span>
                    <span><a href="#" onclick="cut_input()"><i class="layui-icon layui-icon-reduce-circle" style="font-size: 30px; color: #1E9FFF;"></i></a></span>
                </div>
            </div>
